...
public class CustomListAdapter_my_event extends ArrayAdapter<String> {
    ...
    private int flag=1;
    public CustomListAdapter_my_event(Activity context, String[] code, String[] title, String[] date, String[] time, String[] venue, String[] description, String[] rules, String[] contact, String[] requirement, String[] type, String[] link) {
