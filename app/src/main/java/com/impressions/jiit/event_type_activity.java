...
public class event_type_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_event_type_activity);
        clicked=CustomListAdapter_type_event.type_clicked;
        if(clicked==""||clicked==null){
            clicked="";
        }
        event_of_this_type(clicked);

    }


    public void event_of_this_type(final String search_string) {
        class LoginAsync extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progress = new ProgressDialog(event_type_activity.this);
            ...
            protected String doInBackground(String... params) {
                ...
                try{
                    ...
                    HttpPost httpPost = new HttpPost("http://jiitimpressions.com/impressions_app/event_of_this_type.php");
